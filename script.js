...
function renderQuestions() {
    ...
    questions.forEach(function (question, questionIndex) {
        ...
        questionItem.innerHTML = `
            ...
            <button onclick="addOption(${questionIndex})">Thêm phương án</button>
            <button onclick="editQuestion(${questionIndex})">Chỉnh sửa</button>
            <button onclick="deleteQuestion(${questionIndex})">Xóa</button>
            <button onclick="selectCorrectAnswer(${questionIndex})">Chọn đáp án Đúng</button>
        `;
